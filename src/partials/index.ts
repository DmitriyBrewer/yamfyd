...
export { ProfileHeader } from "../components/profle-header";
export { ProfilePrev } from "../components/profile-prev";
export { ProfileContent } from "../components/profile-content";
export { ProfileParams } from "../components/profile-params";
export { ProfileRoot } from "../components/profile-root";
